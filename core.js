...
if (typeof DALNEFRE !== 'undefined') {
	throw Error('Namespace "DALNEFRE" already defined!');
}
if (Object.extend) {
	throw Error('Object.extend already defined!');
}

var DALNEFRE = (function (self) {
...
//				debug('shuffle: <'+this.members.join(',')+'> '+N+' <'+data.join(',')+'> ');
	...
	self = {
		...
		AbstractMembersArray: AbstractMembersArray,
		Set: Set,
		Queue: Queue,
		Sequence: Sequence,
